# Blackout Hunt 0.5.0-beta.1 Release Notes
...
## Changes Since 0.4.0-beta.1

- Ships `0.5.0-beta.1` and supersedes `0.4.0-beta.1`.
...
- Classroom packages use procedural fallback jumpscare visuals by default; the unresolved SCP096 prototype is excluded from normal cook/stage paths.
...
- Native Linux and Fedora/Wine builds remain best-effort compatibility tracks. A Linux classroom archive is available for compatibility validation, but Windows classroom validation remains the release gate.
...
- `BlackoutHunt-0.5.0-beta.1-Windows-Classroom-20260528-035104.zip`
- `BlackoutHunt-0.5.0-beta.1-Windows-Classroom-20260528-035104.zip.sha256`
- `BlackoutHunt-0.5.0-beta.1-Linux-Classroom-20260528-125358.zip`
...
- Unreal automation passed with `Automation RunTests BlackoutHunt`: 32 succeeded, 0 failed. Report path: `Saved\Automation\0.5.0-beta.1-20260528-035447\Report`.
