...
void BuildForcesExtension(TArray<FBHRevisionQuestion>& Bank)
{
	static const FRevisionSpec MC[] = {
		...
		{TEXT("Inertia"), TEXT("Which object has the greatest inertia?"), {TEXT("The object with the greatest mass"), TEXT("The object with the greatest temperature"), TEXT("The object with the smallest volume"), TEXT("The object with no velocity")}, 0, TEXT("Inertia is resistance to changing motion."), TEXT("Link inertia to mass."), TEXT("Greater mass means greater inertia, so motion is harder to change."), EBHDiagramType::ForceArrows, TEXT("inertia increases with mass"), 0.0f, 0.0f},
		{TEXT("Momentum"), TEXT("Which unit is suitable for momentum?"), {TEXT("kg m/s"), TEXT("N/m^2"), TEXT("J/s"), TEXT("m/s^2")}, 0, TEXT("Momentum is mass times velocity."), TEXT("Multiply kg by m/s."), TEXT("p = mv, so the unit is kg m/s."), EBHDiagramType::ForceArrows, TEXT("p = mv"), 0.0f, 0.0f},
	...
	static const FRevisionSpec TF[] = {
		{TEXT("Acceleration"), TEXT("True or false: acceleration can be negative when an object slows down."), {TEXT("True"), TEXT("False"), TEXT("Only if mass is zero"), TEXT("Only in space")}, 0, TEXT("Acceleration is a change in velocity."), TEXT("Think about deceleration as acceleration in the opposite direction."), TEXT("Negative acceleration can represent slowing down in the chosen positive direction."), EBHDiagramType::VelocityGraph, TEXT("a = change in velocity / time"), 0.0f, 0.0f},
		{TEXT("Scalars"), TEXT("True or false: speed is a scalar quantity."), {TEXT("True"), TEXT("False"), TEXT("Only at constant speed"), TEXT("Only with direction")}, 0, TEXT("Scalars have magnitude only."), TEXT("Compare speed with velocity."), TEXT("Speed has size but no direction, so it is scalar."), EBHDiagramType::MotionGraph, TEXT("scalar = magnitude only"), 0.0f, 0.0f},
		{TEXT("Mass and weight"), TEXT("True or false: a student's mass changes when they move from Earth to the Moon."), {TEXT("False"), TEXT("True"), TEXT("Only if they run"), TEXT("Only if they are stationary")}, 0, TEXT("Mass is amount of matter."), TEXT("Weight changes with gravitational field strength."), TEXT("Mass stays the same; weight changes because gravitational field strength changes."), EBHDiagramType::ForceArrows, TEXT("W = mg"), 0.0f, 0.0f},
		{TEXT("Resultant force"), TEXT("True or false: an unbalanced resultant force causes acceleration."), {TEXT("True"), TEXT("False"), TEXT("Only for springs"), TEXT("Only for light")}, 0, TEXT("Use Newton's second law."), TEXT("Link resultant force to change in velocity."), TEXT("A non-zero resultant force causes acceleration."), EBHDiagramType::ForceArrows, TEXT("F = ma"), 0.0f, 0.0f},
		{TEXT("Hooke's law"), TEXT("True or false: Hooke's law applies after the spring has passed its limit of proportionality."), {TEXT("False"), TEXT("True"), TEXT("Only for rubber bands"), TEXT("Only for small masses after the limit")}, 0, TEXT("The straight-line region matters."), TEXT("Find where the force-extension graph stops being linear."), TEXT("Hooke's law applies only while extension is proportional to force."), EBHDiagramType::SpringGraph, TEXT("F = kx before the limit"), 0.0f, 0.0f}
	};
	static const FRevisionSpec Calc[] = {
		{TEXT("Average speed"), TEXT("A student walks 150 m in 25 s. What is the average speed?"), {TEXT("6 m/s"), TEXT("0.17 m/s"), TEXT("125 m/s"), TEXT("175 m/s")}, 0, TEXT("Use distance divided by time."), TEXT("Show 150 / 25."), TEXT("Average speed = 150 / 25 = 6 m/s."), EBHDiagramType::MotionGraph, TEXT("speed = distance / time"), 6.0f, 0.1f},
		{TEXT("Distance"), TEXT("A trolley moves at 12 m/s for 8 s. How far does it travel?"), {TEXT("96 m"), TEXT("20 m"), TEXT("1.5 m"), TEXT("4 m")}, 0, TEXT("Rearrange speed = distance / time."), TEXT("Multiply speed by time."), TEXT("Distance = 12 x 8 = 96 m."), EBHDiagramType::MotionGraph, TEXT("distance = speed x time"), 96.0f, 0.1f},
		{TEXT("Acceleration"), TEXT("Velocity increases from 6 m/s to 18 m/s in 4 s. What is acceleration?"), {TEXT("3 m/s^2"), TEXT("6 m/s^2"), TEXT("12 m/s^2"), TEXT("24 m/s^2")}, 0, TEXT("Find the change in velocity first."), TEXT("Show (18 - 6) / 4."), TEXT("Acceleration = 12 / 4 = 3 m/s^2."), EBHDiagramType::VelocityGraph, TEXT("a = (v - u) / t"), 3.0f, 0.1f},
		{TEXT("Newton's second law"), TEXT("A 2.5 kg cart accelerates at 4 m/s^2. What resultant force acts?"), {TEXT("10 N"), TEXT("1.6 N"), TEXT("6.5 N"), TEXT("25 N")}, 0, TEXT("Use F = ma."), TEXT("Multiply mass by acceleration."), TEXT("F = 2.5 x 4 = 10 N."), EBHDiagramType::ForceArrows, TEXT("F = ma"), 10.0f, 0.1f},
		{TEXT("Pressure"), TEXT("A 200 N force acts over 0.50 m^2. What pressure is produced?"), {TEXT("400 Pa"), TEXT("100 Pa"), TEXT("200.5 Pa"), TEXT("0.0025 Pa")}, 0, TEXT("Pressure is force divided by area."), TEXT("Show 200 / 0.50."), TEXT("Pressure = 200 / 0.50 = 400 Pa."), EBHDiagramType::ForceArrows, TEXT("p = F / A"), 400.0f, 0.5f},
		{TEXT("Momentum"), TEXT("A 0.80 kg trolley moves at 5 m/s. What is its momentum?"), {TEXT("4 kg m/s"), TEXT("6.25 kg m/s"), TEXT("0.16 kg m/s"), TEXT("5.8 kg m/s")}, 0, TEXT("Use p = mv."), TEXT("Multiply 0.80 by 5."), TEXT("Momentum = 0.80 x 5 = 4 kg m/s."), EBHDiagramType::ForceArrows, TEXT("p = mv"), 4.0f, 0.1f},
		{TEXT("Moment"), TEXT("A 15 N force acts 0.20 m from a pivot. What is the moment?"), {TEXT("3 Nm"), TEXT("75 Nm"), TEXT("15.2 Nm"), TEXT("0.013 Nm")}, 0, TEXT("Moment is force times perpendicular distance."), TEXT("Show 15 x 0.20."), TEXT("Moment = 15 x 0.20 = 3 Nm."), EBHDiagramType::MomentBeam, TEXT("moment = Fd"), 3.0f, 0.1f}
	};
	static const FRevisionSpec Skill[] = {
		{TEXT("Free-body diagrams"), TEXT("A lift moves upward at constant speed. Which force explanation earns full marks?"), {TEXT("Upward cable tension balances weight, so resultant force is zero"), TEXT("Tension must be larger because the lift is moving up"), TEXT("Weight disappears because the lift is moving"), TEXT("There is no normal contact force in a lift")}, 0, TEXT("Constant speed means no acceleration."), TEXT("Use balanced forces, not just direction of motion."), TEXT("At constant velocity, the resultant force is zero, so tension balances weight."), EBHDiagramType::ForceArrows, TEXT("exam skill: constant velocity means balanced forces"), 0.0f, 0.0f},
...
void BuildElectricityExtension(TArray<FBHRevisionQuestion>& Bank)
{
	...
	static const FRevisionSpec Calc[] = {
		{TEXT("Charge flow"), TEXT("A 2 A current flows for 30 s. How much charge passes?"), {TEXT("60 C"), TEXT("15 C"), TEXT("32 C"), TEXT("0.067 C")}, 0, TEXT("Use Q = It."), TEXT("Multiply current by time."), TEXT("Q = 2 x 30 = 60 C."), EBHDiagramType::Circuit, TEXT("Q = It"), 60.0f, 0.1f},
		{TEXT("Current"), TEXT("48 C of charge passes a point in 12 s. What is the current?"), {TEXT("4 A"), TEXT("60 A"), TEXT("0.25 A"), TEXT("36 A")}, 0, TEXT("Use I = Q / t."), TEXT("Divide charge by time."), TEXT("I = 48 / 12 = 4 A."), EBHDiagramType::Circuit, TEXT("I = Q / t"), 4.0f, 0.1f},
		{TEXT("Potential difference"), TEXT("A device transfers 90 J to 15 C. What is the potential difference?"), {TEXT("6 V"), TEXT("75 V"), TEXT("105 V"), TEXT("1350 V")}, 0, TEXT("Use V = E / Q."), TEXT("Divide energy by charge."), TEXT("V = 90 / 15 = 6 V."), EBHDiagramType::Circuit, TEXT("V = E / Q"), 6.0f, 0.1f},
		{TEXT("Resistance"), TEXT("A resistor has 9 V across it and current 0.30 A. What is its resistance?"), {TEXT("30 ohms"), TEXT("2.7 ohms"), TEXT("9.3 ohms"), TEXT("0.033 ohms")}, 0, TEXT("Use R = V / I."), TEXT("Divide voltage by current."), TEXT("R = 9 / 0.30 = 30 ohms."), EBHDiagramType::IVGraph, TEXT("R = V / I"), 30.0f, 0.1f},
		{TEXT("Power"), TEXT("A lamp has 6 V across it and current 0.50 A. What is its power?"), {TEXT("3 W"), TEXT("12 W"), TEXT("6.5 W"), TEXT("0.083 W")}, 0, TEXT("Use P = IV."), TEXT("Multiply current by voltage."), TEXT("P = 0.50 x 6 = 3 W."), EBHDiagramType::Circuit, TEXT("P = IV"), 3.0f, 0.1f},
		{TEXT("Energy transferred"), TEXT("A 40 W lamp is on for 60 s. How much energy is transferred?"), {TEXT("2400 J"), TEXT("100 J"), TEXT("1.5 J"), TEXT("240 J")}, 0, TEXT("Use E = Pt."), TEXT("Multiply power by time."), TEXT("E = 40 x 60 = 2400 J."), EBHDiagramType::Circuit, TEXT("E = Pt"), 2400.0f, 1.0f},
	...
	static const FRevisionSpec Skill[] = {
		{TEXT("Meter placement"), TEXT("A student gets no useful IV results. The ammeter is across the resistor and the voltmeter is in series. What correction is needed?"), {TEXT("Ammeter in series and voltmeter in parallel"), TEXT("Both meters in parallel"), TEXT("Both meters in series"), TEXT("Remove the resistor")}, 0, TEXT("Current through, voltage across."), TEXT("Place the ammeter in the main loop."), TEXT("The ammeter must be in series and the voltmeter in parallel with the component."), EBHDiagramType::Circuit, TEXT("exam skill: correct meter placement"), 0.0f, 0.0f},
		{TEXT("IV graph"), TEXT("A resistor's IV graph is straight through the origin. What conclusion is best?"), {TEXT("Current is proportional to voltage, so resistance is constant"), TEXT("Resistance is zero at all voltages"), TEXT("The component is a thermistor heating up"), TEXT("The voltmeter was connected incorrectly")}, 0, TEXT("Straight through origin means proportional."), TEXT("Link graph shape to Ohm's law."), TEXT("A straight IV graph through the origin shows an ohmic conductor at constant temperature."), EBHDiagramType::IVGraph, TEXT("exam skill: interpret an ohmic graph"), 0.0f, 0.0f},
		{TEXT("Fuse choice"), TEXT("A 1200 W heater runs from 230 V. Which reasoning helps choose a fuse?"), {TEXT("Normal current is about 5.2 A, so use the next rating above it"), TEXT("Use a fuse below 1 A because heaters are hot"), TEXT("Use the largest fuse available every time"), TEXT("Fuse rating must equal power in watts")}, 0, TEXT("Estimate current using I = P / V."), TEXT("Choose a rating just above normal current."), TEXT("The normal current is about 1200 / 230 = 5.2 A, so the fuse should be just above that."), EBHDiagramType::Circuit, TEXT("exam skill: choose a fuse"), 0.0f, 0.0f},
	...
	static const FRevisionSpec Match[] = {
		...
		{TEXT("Circuit rules"), TEXT("Match the circuit type to the rule."), {TEXT("Series -> same current; parallel -> same potential difference"), TEXT("Series -> same potential difference; parallel -> same current"), TEXT("Series -> no resistance; parallel -> no voltage"), TEXT("Series -> branches; parallel -> one path only")}, 0, TEXT("Series has one path; parallel has branches."), TEXT("Trace current and compare p.d."), TEXT("Series circuits have the same current; parallel branches share the same p.d."), EBHDiagramType::Circuit, TEXT("series I, parallel V"), 0.0f, 0.0f},
		{TEXT("Components"), TEXT("Match the component to its behaviour."), {TEXT("Diode -> one-way current; fuse -> melts when current is too high"), TEXT("Diode -> stores energy; fuse -> measures voltage"), TEXT("LDR -> current only one way; ammeter -> parallel only"), TEXT("Cell -> protects earth wire; switch -> increases resistance only when hot")}, 0, TEXT("Think function, not symbol shape only."), TEXT("Use the safety role of a fuse."), TEXT("A diode controls current direction; a fuse protects by melting at high current."), EBHDiagramType::Circuit, TEXT("component functions"), 0.0f, 0.0f},
...
void BuildWavesExtension(TArray<FBHRevisionQuestion>& Bank)
{
	...
	static const FRevisionSpec TF[] = {
		...
		{TEXT("EM speed"), TEXT("True or false: all electromagnetic waves travel at the same speed in a vacuum."), {TEXT("True"), TEXT("False"), TEXT("Only visible light"), TEXT("Only radio waves")}, 0, TEXT("They differ by frequency and wavelength."), TEXT("Use the vacuum speed of light."), TEXT("All EM waves travel at the same speed in a vacuum."), EBHDiagramType::EMSpectrum, TEXT("c = f lambda"), 0.0f, 0.0f}
	};
	static const FRevisionSpec Calc[] = {
		{TEXT("Wave speed"), TEXT("A wave has frequency 12 Hz and wavelength 0.50 m. What is its speed?"), {TEXT("6 m/s"), TEXT("24 m/s"), TEXT("12.5 m/s"), TEXT("0.042 m/s")}, 0, TEXT("Use v = f lambda."), TEXT("Multiply frequency by wavelength."), TEXT("v = 12 x 0.50 = 6 m/s."), EBHDiagramType::Wave, TEXT("v = f lambda"), 6.0f, 0.1f},
		{TEXT("Frequency"), TEXT("A wave speed is 20 m/s and wavelength is 4 m. What is frequency?"), {TEXT("5 Hz"), TEXT("80 Hz"), TEXT("16 Hz"), TEXT("0.20 Hz")}, 0, TEXT("Rearrange v = f lambda."), TEXT("Divide speed by wavelength."), TEXT("f = 20 / 4 = 5 Hz."), EBHDiagramType::Wave, TEXT("f = v / lambda"), 5.0f, 0.1f},
		{TEXT("Wavelength"), TEXT("A wave travels at 30 m/s with frequency 10 Hz. What is its wavelength?"), {TEXT("3 m"), TEXT("300 m"), TEXT("20 m"), TEXT("0.33 m")}, 0, TEXT("Use wavelength = speed / frequency."), TEXT("Divide 30 by 10."), TEXT("Wavelength = 30 / 10 = 3 m."), EBHDiagramType::Wave, TEXT("lambda = v / f"), 3.0f, 0.1f},
		{TEXT("Period"), TEXT("A wave has frequency 8 Hz. What is its period?"), {TEXT("0.125 s"), TEXT("8 s"), TEXT("64 s"), TEXT("0.8 s")}, 0, TEXT("Use T = 1 / f."), TEXT("Find one divided by 8."), TEXT("T = 1 / 8 = 0.125 s."), EBHDiagramType::Wave, TEXT("T = 1 / f"), 0.125f, 0.01f},
		{TEXT("Echo"), TEXT("An echo returns after 0.40 s from a wall 68 m away. What speed of sound is measured?"), {TEXT("340 m/s"), TEXT("170 m/s"), TEXT("27.2 m/s"), TEXT("68.4 m/s")}, 0, TEXT("The sound travels there and back."), TEXT("Use total distance 136 m."), TEXT("Speed = 2 x 68 / 0.40 = 340 m/s."), EBHDiagramType::Wave, TEXT("speed = distance / time"), 340.0f, 1.0f},
		{TEXT("Critical angle"), TEXT("A material has refractive index 1.25. For material to air, what is sin c?"), {TEXT("0.8"), TEXT("1.25"), TEXT("0.25"), TEXT("2.5")}, 0, TEXT("Use n = 1 / sin c."), TEXT("Rearrange to sin c = 1 / n."), TEXT("sin c = 1 / 1.25 = 0.8."), EBHDiagramType::RayDiagram, TEXT("n = 1 / sin c"), 0.8f, 0.01f},
...
{
	static const FRevisionSpec MC[] = {
		{TEXT("Energy stores"), TEXT("Which store increases when a spring is stretched?"), {TEXT("Elastic potential"), TEXT("Nuclear"), TEXT("Magnetic only"), TEXT("Chemical in air")}, 0, TEXT("Stretching stores energy elastically."), TEXT("Name the store linked to deformation."), TEXT("A stretched spring has increased elastic potential energy."), EBHDiagramType::EnergyChain, TEXT("elastic store"), 0.0f, 0.0f},
		{TEXT("Kinetic energy"), TEXT("What happens to kinetic energy if speed doubles and mass stays the same?"), {TEXT("It becomes four times larger"), TEXT("It doubles"), TEXT("It halves"), TEXT("It becomes zero")}, 0, TEXT("Kinetic energy depends on speed squared."), TEXT("Use Ek = 1/2 mv^2."), TEXT("Doubling speed makes v^2 four times larger, so kinetic energy quadruples."), EBHDiagramType::EnergyChain, TEXT("Ek = 1/2 mv^2"), 0.0f, 0.0f},
		...
		{TEXT("Power"), TEXT("Which definition of power is correct?"), {TEXT("Rate of energy transfer"), TEXT("Total distance travelled"), TEXT("Force per unit area"), TEXT("Charge per unit voltage")}, 0, TEXT("Power is measured in watts."), TEXT("One watt is one joule per second."), TEXT("Power is the rate of energy transfer or doing work."), EBHDiagramType::EnergyChain, TEXT("P = E / t"), 0.0f, 0.0f},
		{TEXT("Efficiency"), TEXT("Which device is more efficient?"), {TEXT("One with greater useful output for the same input"), TEXT("One with greater wasted output for the same input"), TEXT("One with no energy input"), TEXT("One that destroys energy")}, 0, TEXT("Efficiency compares useful output with total input."), TEXT("Useful output should be a larger fraction."), TEXT("A more efficient device transfers a greater fraction of input energy usefully."), EBHDiagramType::Sankey, TEXT("efficiency = useful / input"), 0.0f, 0.0f},
	...
	static const FRevisionSpec TF[] = {
		...
		{TEXT("Work done"), TEXT("True or false: work is done when a force moves an object through a distance."), {TEXT("True"), TEXT("False"), TEXT("Only if the force is zero"), TEXT("Only for electricity")}, 0, TEXT("Work done is energy transferred mechanically."), TEXT("Use force times distance."), TEXT("Work is done when a force causes movement through a distance."), EBHDiagramType::EnergyChain, TEXT("W = Fd"), 0.0f, 0.0f},
		{TEXT("Sankey diagrams"), TEXT("True or false: the width of a Sankey arrow represents the amount of energy."), {TEXT("True"), TEXT("False"), TEXT("Only the input arrow"), TEXT("Only wasted arrows")}, 0, TEXT("Wider arrows mean more energy."), TEXT("Compare input, useful, and wasted arrows."), TEXT("In a Sankey diagram, arrow width represents energy amount."), EBHDiagramType::Sankey, TEXT("arrow width = energy"), 0.0f, 0.0f},
		{TEXT("Thermal radiation"), TEXT("True or false: thermal radiation can travel through a vacuum."), {TEXT("True"), TEXT("False"), TEXT("Only by convection"), TEXT("Only through metals")}, 0, TEXT("Radiation uses electromagnetic waves."), TEXT("The Sun warms Earth through space."), TEXT("Thermal radiation can travel through a vacuum."), EBHDiagramType::EnergyChain, TEXT("radiation no medium needed"), 0.0f, 0.0f},
		{TEXT("Fossil fuels"), TEXT("True or false: fossil fuels are renewable on human timescales."), {TEXT("False"), TEXT("True"), TEXT("Only coal is renewable"), TEXT("Only gas is renewable")}, 0, TEXT("They take millions of years to form."), TEXT("Compare formation time with use time."), TEXT("Fossil fuels are non-renewable on human timescales."), EBHDiagramType::EnergyChain, TEXT("fossil fuels non-renewable"), 0.0f, 0.0f}
	};
	static const FRevisionSpec Calc[] = {
		{TEXT("Efficiency"), TEXT("A motor takes 800 J and gives 200 J useful output. What is efficiency?"), {TEXT("25%"), TEXT("75%"), TEXT("400%"), TEXT("600%")}, 0, TEXT("Use useful output divided by input times 100."), TEXT("Show 200 / 800 x 100."), TEXT("Efficiency = 200 / 800 x 100 = 25%."), EBHDiagramType::Sankey, TEXT("efficiency = useful / input x 100%"), 25.0f, 0.1f},
		{TEXT("Work done"), TEXT("A 50 N force moves a box 4 m. What work is done?"), {TEXT("200 J"), TEXT("54 J"), TEXT("12.5 J"), TEXT("46 J")}, 0, TEXT("Use W = Fd."), TEXT("Multiply force by distance."), TEXT("Work done = 50 x 4 = 200 J."), EBHDiagramType::EnergyChain, TEXT("W = Fd"), 200.0f, 0.1f},
		{TEXT("GPE"), TEXT("A 5 kg mass is lifted 3 m. Use g = 10 N/kg. What GPE is gained?"), {TEXT("150 J"), TEXT("18 J"), TEXT("50 J"), TEXT("15 J")}, 0, TEXT("Use Ep = mgh."), TEXT("Multiply mass, g, and height."), TEXT("Ep = 5 x 10 x 3 = 150 J."), EBHDiagramType::EnergyChain, TEXT("Ep = mgh"), 150.0f, 0.1f},
		{TEXT("Kinetic energy"), TEXT("A 4 kg trolley moves at 3 m/s. What is its kinetic energy?"), {TEXT("18 J"), TEXT("12 J"), TEXT("36 J"), TEXT("6 J")}, 0, TEXT("Use Ek = 1/2 mv^2."), TEXT("Square the velocity first."), TEXT("Ek = 0.5 x 4 x 3^2 = 18 J."), EBHDiagramType::EnergyChain, TEXT("Ek = 1/2 mv^2"), 18.0f, 0.1f},
		{TEXT("Power"), TEXT("A student transfers 600 J in 15 s. What is the power?"), {TEXT("40 W"), TEXT("9000 W"), TEXT("615 W"), TEXT("0.025 W")}, 0, TEXT("Power is energy divided by time."), TEXT("Show 600 / 15."), TEXT("Power = 600 / 15 = 40 W."), EBHDiagramType::EnergyChain, TEXT("P = E / t"), 40.0f, 0.1f},
		{TEXT("Specific heat capacity"), TEXT("A 2 kg block with c = 500 J/kg degree C warms by 3 degree C. What energy is transferred?"), {TEXT("3000 J"), TEXT("505 J"), TEXT("1500 J"), TEXT("333 J")}, 0, TEXT("Use E = mc delta T."), TEXT("Multiply 2 x 500 x 3."), TEXT("E = 2 x 500 x 3 = 3000 J."), EBHDiagramType::EnergyChain, TEXT("E = mc delta T"), 3000.0f, 1.0f},
		{TEXT("Wasted energy"), TEXT("A device takes 250 J and gives 160 J useful output. How much is wasted?"), {TEXT("90 J"), TEXT("410 J"), TEXT("1.56 J"), TEXT("160 J")}, 0, TEXT("Input equals useful plus wasted."), TEXT("Subtract useful output from input."), TEXT("Wasted energy = 250 - 160 = 90 J."), EBHDiagramType::Sankey, TEXT("wasted = input - useful"), 90.0f, 0.1f}
	};
	static const FRevisionSpec Skill[] = {
		{TEXT("Sankey evaluation"), TEXT("Two lamps use the same input energy. Lamp A has a wider useful light arrow. What should the conclusion say?"), {TEXT("Lamp A is more efficient because a larger fraction is useful light"), TEXT("Lamp A wastes more energy because useful arrows are ignored"), TEXT("Both lamps must be 100% efficient"), TEXT("Efficiency cannot be compared from a Sankey diagram")}, 0, TEXT("Compare useful fractions."), TEXT("Use arrow widths as evidence."), TEXT("A wider useful output arrow for the same input means a greater useful fraction and higher efficiency."), EBHDiagramType::Sankey, TEXT("exam skill: compare Sankey diagrams"), 0.0f, 0.0f},
		{TEXT("Thermal insulation"), TEXT("A student compares cups with different insulation. Which method is fairest?"), {TEXT("Use equal water volumes and same starting temperature"), TEXT("Use different volumes to save time"), TEXT("Start one cup hotter to see it better"), TEXT("Change the room temperature for each cup")}, 0, TEXT("Only insulation should change."), TEXT("Keep starting conditions the same."), TEXT("A fair insulation comparison keeps volume, starting temperature, container size, and surroundings controlled."), EBHDiagramType::EnergyChain, TEXT("exam skill: control variables"), 0.0f, 0.0f},
		{TEXT("Specific heat practical"), TEXT("In an electrical heating experiment, why should the block be insulated?"), {TEXT("To reduce energy transfer to surroundings so the calculated c is more accurate"), TEXT("To stop current flowing through the heater"), TEXT("To make the mass zero"), TEXT("To increase room temperature deliberately")}, 0, TEXT("Energy losses affect the result."), TEXT("Think about where supplied energy goes."), TEXT("Insulation reduces energy losses, so more supplied energy heats the block."), EBHDiagramType::EnergyChain, TEXT("exam skill: reduce heat loss"), 0.0f, 0.0f},
		{TEXT("Resource comparison"), TEXT("A school considers solar panels. Which evaluation is strongest?"), {TEXT("Solar is renewable and low-emission in use, but output depends on light intensity"), TEXT("Solar is non-renewable because panels are black"), TEXT("Solar always gives full power at night"), TEXT("Solar produces greenhouse gases whenever light hits it")}, 0, TEXT("Give both advantage and limitation."), TEXT("Mention variable output."), TEXT("Solar power is renewable and low-emission during use, but output varies with light intensity and weather."), EBHDiagramType::EnergyChain, TEXT("exam skill: evaluate resources"), 0.0f, 0.0f},
		{TEXT("Energy stores"), TEXT("A ball is thrown upward. Which account is best as it rises?"), {TEXT("Kinetic energy decreases while gravitational potential energy increases"), TEXT("Chemical energy becomes nuclear energy only"), TEXT("Energy is destroyed because speed decreases"), TEXT("Thermal energy becomes charge")}, 0, TEXT("Track speed and height."), TEXT("Energy is transferred between stores."), TEXT("As the ball rises, kinetic energy is transferred to gravitational potential energy, with small losses."), EBHDiagramType::EnergyChain, TEXT("exam skill: track stores"), 0.0f, 0.0f},
		{TEXT("Power explanation"), TEXT("Two motors lift the same load to the same height. Motor A takes less time. What is true?"), {TEXT("Motor A has greater power because it transfers the same energy faster"), TEXT("Motor A does less work because time is shorter"), TEXT("Motor A has no energy input"), TEXT("Motor A must be less efficient")}, 0, TEXT("Power is energy transfer per second."), TEXT("Same work in less time means greater power."), TEXT("For the same energy transfer, a shorter time means a higher power."), EBHDiagramType::EnergyChain, TEXT("exam skill: relate power and time"), 0.0f, 0.0f}
	};
	static const FRevisionSpec Graph[] = {
		{TEXT("Sankey"), TEXT("A Sankey input is 500 J and useful output is 300 J. What is the wasted output?"), {TEXT("200 J"), TEXT("800 J"), TEXT("60 J"), TEXT("1.67 J")}, 0, TEXT("Input splits into useful and wasted."), TEXT("Subtract useful from total input."), TEXT("Wasted output = 500 - 300 = 200 J."), EBHDiagramType::Sankey, TEXT("input = useful + wasted"), 200.0f, 0.1f},
		{TEXT("Cooling graph"), TEXT("Which cooling curve shows the best insulation?"), {TEXT("The curve with the smallest temperature drop in the same time"), TEXT("The curve dropping fastest"), TEXT("The curve with the highest final room temperature"), TEXT("The curve with no starting point")}, 0, TEXT("Good insulation slows energy loss."), TEXT("Compare temperature change over the same time."), TEXT("The best insulation gives the slowest temperature decrease."), EBHDiagramType::EnergyChain, TEXT("less drop -> better insulation"), 0.0f, 0.0f},
		{TEXT("Efficiency bar"), TEXT("A device is 65% efficient with 1000 J input. How much useful energy is output?"), {TEXT("650 J"), TEXT("65 J"), TEXT("350 J"), TEXT("1538 J")}, 0, TEXT("Find 65% of the input."), TEXT("Use 0.65 x 1000."), TEXT("Useful energy = 0.65 x 1000 = 650 J."), EBHDiagramType::Sankey, TEXT("useful = efficiency x input"), 650.0f, 1.0f},
		{TEXT("Heating graph"), TEXT("A temperature-time graph has a steeper rising line for the same heater. What does that suggest?"), {TEXT("The sample has lower thermal capacity or lower mass"), TEXT("The sample has no energy input"), TEXT("The heater is switched off"), TEXT("Energy is destroyed faster")}, 0, TEXT("Steeper temperature rise means faster temperature change."), TEXT("For the same power, less energy is needed per degree."), TEXT("A steeper rise suggests less energy is needed for each degree C, such as lower mass or lower heat capacity."), EBHDiagramType::EnergyChain, TEXT("temperature gradient"), 0.0f, 0.0f}
	};
	static const FRevisionSpec Match[] = {
	...
	static const FRevisionSpec Order[] = {
		...
		{TEXT("Energy store transfer"), TEXT("Order the main energy change as a roller cart rolls downhill."), {TEXT("Gravitational store decreases -> kinetic store increases -> some energy dissipates thermally"), TEXT("Thermal store decreases -> nuclear store increases -> kinetic becomes zero"), TEXT("Chemical store appears -> gravitational store increases -> speed falls"), TEXT("Electrical store rises -> charge flows -> height increases")}, 0, TEXT("Height decreases and speed increases."), TEXT("Include dissipated energy for real motion."), TEXT("As the cart descends, gravitational potential energy transfers mostly to kinetic energy, with some dissipated thermally."), EBHDiagramType::EnergyChain, TEXT("GPE to KE plus losses"), 0.0f, 0.0f}
	};
