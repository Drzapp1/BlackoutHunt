...
void BuildForces(TArray<FBHRevisionQuestion>& Bank)
{
	...
	static const FRevisionSpec Formula[] = {
		{TEXT("Formula recall"), TEXT("Fill the formula: average speed = total distance / ____"), {TEXT("total time"), TEXT("mass"), TEXT("force"), TEXT("current")}, 0, TEXT("Speed compares distance with time."), TEXT("Read the units m and s."), TEXT("Average speed = total distance / total time."), EBHDiagramType::MotionGraph, TEXT("average speed = total distance / total time"), 0.0f, 0.0f},
		{TEXT("Formula substitution"), TEXT("For a = (v - u) / t, what does u mean?"), {TEXT("initial velocity"), TEXT("final velocity"), TEXT("time"), TEXT("distance")}, 0, TEXT("u is the starting velocity."), TEXT("Label u and v on the velocity-time sketch."), TEXT("u is initial velocity and v is final velocity."), EBHDiagramType::VelocityGraph, TEXT("a = (v - u) / t"), 0.0f, 0.0f},
		{TEXT("Weight formula"), TEXT("Fill the formula for weight: W = ____"), {TEXT("mg"), TEXT("m/g"), TEXT("g/m"), TEXT("ma/t")}, 0, TEXT("Weight is mass times gravitational field strength."), TEXT("Use units kg and N/kg."), TEXT("W = mg."), EBHDiagramType::ForceArrows, TEXT("W = mg"), 0.0f, 0.0f},
		{TEXT("Hooke's law"), TEXT("In F = kx, what does x represent?"), {TEXT("extension"), TEXT("spring constant"), TEXT("weight"), TEXT("moment")}, 0, TEXT("x is how much the spring stretches."), TEXT("Label the original and stretched lengths."), TEXT("x is extension, measured in metres."), EBHDiagramType::SpringGraph, TEXT("F = kx"), 0.0f, 0.0f},
		{TEXT("Momentum"), TEXT("Fill the formula: momentum p = ____"), {TEXT("mv"), TEXT("m/v"), TEXT("F/t"), TEXT("Fd")}, 0, TEXT("Momentum depends on mass and velocity."), TEXT("Check the unit kg m/s."), TEXT("p = mv."), EBHDiagramType::ForceArrows, TEXT("p = mv"), 0.0f, 0.0f},
		{TEXT("Moments"), TEXT("Which formula completes the pivot note? moment = ____"), {TEXT("force x perpendicular distance"), TEXT("mass x velocity"), TEXT("current x time"), TEXT("work / time")}, 0, TEXT("Use the shortest distance from pivot to force line."), TEXT("Draw the perpendicular distance."), TEXT("Moment = force x perpendicular distance from the pivot."), EBHDiagramType::MomentBeam, TEXT("moment = Fd"), 0.0f, 0.0f}
	};
	...
	AddSpecs(Bank, EBHPhysicsTopic::ForcesAndMotion, TEXT("forces"), TEXT("Forces and Motion"), EBHQuestionType::FormulaFill, Formula, UE_ARRAY_COUNT(Formula));
...
{
	static const FRevisionSpec MC[] = {
		{TEXT("Current"), TEXT("What does current measure in the haunted lab circuit?"), {TEXT("Rate of flow of charge"), TEXT("Energy per charge"), TEXT("Charge stored in a wire"), TEXT("Resistance per metre")}, 0, TEXT("Current is charge per second."), TEXT("State the formula with Q and t."), TEXT("Current is the rate of flow of charge and is measured in amperes."), EBHDiagramType::Circuit, TEXT("I = Q / t"), 0.0f, 0.0f},
	...
	static const FRevisionSpec Formula[] = {
		{TEXT("Current formula"), TEXT("Fill the formula: I = ____"), {TEXT("Q / t"), TEXT("Qt"), TEXT("V / R only"), TEXT("E / Q")}, 0, TEXT("Current is charge per second."), TEXT("Use charge divided by time."), TEXT("I = Q / t."), EBHDiagramType::Circuit, TEXT("I = Q / t"), 0.0f, 0.0f},
		{TEXT("Ohm's law"), TEXT("Fill the formula: V = ____"), {TEXT("IR"), TEXT("I / R"), TEXT("R / I"), TEXT("Q / t")}, 0, TEXT("Voltage equals current times resistance."), TEXT("Rearrange R = V / I."), TEXT("V = IR."), EBHDiagramType::IVGraph, TEXT("V = IR"), 0.0f, 0.0f},
		{TEXT("Potential difference"), TEXT("In V = E / Q, what does E represent?"), {TEXT("energy transferred"), TEXT("extension"), TEXT("electron number only"), TEXT("efficiency")}, 0, TEXT("Potential difference is energy per charge."), TEXT("Use units J/C."), TEXT("E is energy transferred, measured in joules."), EBHDiagramType::Circuit, TEXT("V = E / Q"), 0.0f, 0.0f},
		{TEXT("Electrical power"), TEXT("Which formula can find power if V and R are known?"), {TEXT("P = V^2 / R"), TEXT("P = R / V^2"), TEXT("P = IVt"), TEXT("P = Q / t")}, 0, TEXT("Combine P = IV with V = IR."), TEXT("Choose the formula using only V and R."), TEXT("P = V^2 / R."), EBHDiagramType::IVGraph, TEXT("P = V^2 / R"), 0.0f, 0.0f},
		{TEXT("Energy"), TEXT("Fill the formula on the emergency worksheet: E = ____"), {TEXT("IVt"), TEXT("I / Vt"), TEXT("IR"), TEXT("Q / t")}, 0, TEXT("Electrical energy uses current, voltage, and time."), TEXT("Multiply I, V, and t."), TEXT("E = IVt."), EBHDiagramType::Circuit, TEXT("E = IVt"), 0.0f, 0.0f},
		{TEXT("Fuse choice"), TEXT("Which rule completes the fuse note? choose a rating ____"), {TEXT("slightly above normal current"), TEXT("below normal current"), TEXT("as high as possible"), TEXT("equal to voltage")}, 0, TEXT("The fuse should not melt during normal use."), TEXT("It must still melt in a fault."), TEXT("A fuse rating should be slightly above the normal current."), EBHDiagramType::Circuit, TEXT("fuse rating just above normal current"), 0.0f, 0.0f}
	};
	static const FRevisionSpec Graph[] = {
	...
	AddSpecs(Bank, EBHPhysicsTopic::Electricity, TEXT("electricity"), TEXT("Electricity"), EBHQuestionType::FormulaFill, Formula, UE_ARRAY_COUNT(Formula));
...
void BuildWaves(TArray<FBHRevisionQuestion>& Bank)
{
	...
	static const FRevisionSpec TF[] = {
		...
		{TEXT("Critical angle"), TEXT("True or false: n = 1 / sin c for the critical angle from glass to air."), {TEXT("True"), TEXT("False"), TEXT("Only for sound"), TEXT("Only for mirrors")}, 0, TEXT("This is the IGCSE critical angle formula."), TEXT("Use c as the critical angle."), TEXT("For a material to air, refractive index n = 1 / sin c."), EBHDiagramType::RayDiagram, TEXT("n = 1 / sin c"), 0.0f, 0.0f}
	};
	static const FRevisionSpec Calc[] = {
	...
	static const FRevisionSpec Formula[] = {
		{TEXT("Wave speed formula"), TEXT("Fill the formula: wave speed v = ____"), {TEXT("f lambda"), TEXT("f / lambda"), TEXT("lambda / f"), TEXT("1 / T only")}, 0, TEXT("Speed equals frequency times wavelength."), TEXT("Check units: Hz times m gives m/s."), TEXT("v = f lambda."), EBHDiagramType::Wave, TEXT("v = f lambda"), 0.0f, 0.0f},
		{TEXT("Period formula"), TEXT("Fill the formula: f = ____"), {TEXT("1 / T"), TEXT("T / 1"), TEXT("v lambda"), TEXT("n sin i")}, 0, TEXT("Frequency and period are reciprocals."), TEXT("Use one complete cycle time."), TEXT("f = 1 / T."), EBHDiagramType::Wave, TEXT("f = 1 / T"), 0.0f, 0.0f},
		{TEXT("Snell's law"), TEXT("Which formula belongs on the refraction board?"), {TEXT("n1 sin i = n2 sin r"), TEXT("F = ma"), TEXT("I = Q / t"), TEXT("Ek = 1/2 mv^2")}, 0, TEXT("Snell's law uses refractive indices and angles."), TEXT("Look for n, i, and r."), TEXT("Snell's law is n1 sin i = n2 sin r."), EBHDiagramType::RayDiagram, TEXT("n1 sin i = n2 sin r"), 0.0f, 0.0f},
		{TEXT("Critical angle"), TEXT("Fill the formula for critical angle: n = ____"), {TEXT("1 / sin c"), TEXT("sin c"), TEXT("c / 1"), TEXT("1 / cos c")}, 0, TEXT("Use the IGCSE formula for material to air."), TEXT("It is the reciprocal of sin c."), TEXT("n = 1 / sin c."), EBHDiagramType::RayDiagram, TEXT("n = 1 / sin c"), 0.0f, 0.0f},
		{TEXT("Echo method"), TEXT("Which formula should the sound team use after measuring echo distance and time?"), {TEXT("speed = distance / time"), TEXT("speed = time / distance"), TEXT("speed = frequency / wavelength"), TEXT("speed = work / time")}, 0, TEXT("Speed is distance divided by time."), TEXT("Remember echo distance is there and back."), TEXT("Use speed = distance / time, with total echo distance."), EBHDiagramType::Wave, TEXT("speed = distance / time"), 0.0f, 0.0f},
		{TEXT("Refraction reasoning"), TEXT("Complete the rule: entering a denser medium, speed ____ and wavelength ____."), {TEXT("decreases; decreases"), TEXT("increases; increases"), TEXT("decreases; frequency decreases"), TEXT("stays same; wavelength stays same")}, 0, TEXT("Frequency stays the same."), TEXT("Use v = f lambda with f constant."), TEXT("In a denser medium speed decreases, frequency stays the same, so wavelength decreases."), EBHDiagramType::RayDiagram, TEXT("v = f lambda"), 0.0f, 0.0f}
	};
	static const FRevisionSpec Graph[] = {
	...
	AddSpecs(Bank, EBHPhysicsTopic::Waves, TEXT("waves"), TEXT("Waves"), EBHQuestionType::FormulaFill, Formula, UE_ARRAY_COUNT(Formula));
...
void BuildEnergy(TArray<FBHRevisionQuestion>& Bank)
{
	...
	static const FRevisionSpec Formula[] = {
		{TEXT("Efficiency"), TEXT("Fill the formula: efficiency = useful energy output / ____ x 100%"), {TEXT("total energy input"), TEXT("wasted energy only"), TEXT("time taken"), TEXT("force")}, 0, TEXT("Compare useful output with total input."), TEXT("Use the full input, not just wasted energy."), TEXT("Efficiency = useful energy output / total energy input x 100%."), EBHDiagramType::Sankey, TEXT("efficiency = useful / total x 100%"), 0.0f, 0.0f},
		{TEXT("Work done"), TEXT("Fill the formula: W = ____"), {TEXT("Fd"), TEXT("F / d"), TEXT("mv"), TEXT("IV")}, 0, TEXT("Work is force times distance moved in the force direction."), TEXT("Check units: N m = J."), TEXT("Work done W = Fd."), EBHDiagramType::EnergyChain, TEXT("W = Fd"), 0.0f, 0.0f},
		{TEXT("Kinetic energy"), TEXT("Which formula gives kinetic energy?"), {TEXT("Ek = 1/2 mv^2"), TEXT("Ep = mgh"), TEXT("P = IV"), TEXT("F = ma")}, 0, TEXT("Kinetic energy depends on velocity squared."), TEXT("Look for v^2."), TEXT("Kinetic energy is Ek = 1/2 mv^2."), EBHDiagramType::EnergyChain, TEXT("Ek = 1/2 mv^2"), 0.0f, 0.0f},
		{TEXT("GPE"), TEXT("Fill the formula for gravitational potential energy: Ep = ____"), {TEXT("mgh"), TEXT("mg/h"), TEXT("1/2 mv^2"), TEXT("F / d")}, 0, TEXT("It depends on mass, gravitational field strength, and height."), TEXT("Check units: kg x N/kg x m = J."), TEXT("Ep = mgh."), EBHDiagramType::EnergyChain, TEXT("Ep = mgh"), 0.0f, 0.0f},
		{TEXT("Power"), TEXT("Fill the formula: power P = ____"), {TEXT("W / t"), TEXT("Wt"), TEXT("Fd"), TEXT("mgh")}, 0, TEXT("Power is work per time."), TEXT("Divide energy or work by time."), TEXT("P = W / t."), EBHDiagramType::EnergyChain, TEXT("P = W / t"), 0.0f, 0.0f},
		{TEXT("Generation chain"), TEXT("Complete a fossil-fuel power station chain."), {TEXT("chemical -> thermal -> kinetic -> electrical"), TEXT("nuclear -> light -> elastic -> magnetic"), TEXT("kinetic -> electrostatic -> nuclear -> chemical"), TEXT("thermal -> chemical -> visible -> gravitational")}, 0, TEXT("Fuel heats water, steam turns turbine, generator makes electricity."), TEXT("Track store to turbine to generator."), TEXT("Fossil fuels transfer chemical energy to thermal energy, then kinetic energy in the turbine, then electrical energy."), EBHDiagramType::EnergyChain, TEXT("chemical -> thermal -> kinetic -> electrical"), 0.0f, 0.0f}
	};
	static const FRevisionSpec Graph[] = {
	...
	AddSpecs(Bank, EBHPhysicsTopic::Energy, TEXT("energy"), TEXT("Energy"), EBHQuestionType::FormulaFill, Formula, UE_ARRAY_COUNT(Formula));
...
bool FBHRevisionQuestionBank::Validate(FString& OutSummary)
{
	...
	OutSummary = FString::Printf(TEXT("Physics revision bank %s: total=%d topics=[%d,%d,%d,%d] types=[mc:%d tf:%d calc:%d formula:%d graph:%d match:%d order:%d]"),
