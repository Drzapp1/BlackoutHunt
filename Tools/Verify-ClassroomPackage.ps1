...
$forbidden = @(
    ...
    @{ Name = "risky low-poly hider external actor/object data"; Pattern = '(^|[\\/])(?:BlackoutHunt[\\/])?Content[\\/]__(?:ExternalActors|ExternalObjects)__[\\/]BlackoutHunt[\\/]Art[\\/]Characters[\\/]Hider[\\/]' },
    @{ Name = "risky FNaTI hunter asset"; Pattern = '(^|[\\/])(?:BlackoutHunt[\\/])?Content[\\/]BlackoutHunt[\\/]Art[\\/]Characters[\\/]Hunter[\\/]' },
    @{ Name = "risky FNaTI hunter external actor/object data"; Pattern = '(^|[\\/])(?:BlackoutHunt[\\/])?Content[\\/]__(?:ExternalActors|ExternalObjects)__[\\/]BlackoutHunt[\\/]Art[\\/]Characters[\\/]Hunter[\\/]' },
    ...
    @{ Name = "downloaded art external actor/object data"; Pattern = '(^|[\\/])(?:BlackoutHunt[\\/])?Content[\\/]__(?:ExternalActors|ExternalObjects)__[\\/]BlackoutHunt[\\/]Art[\\/]Downloaded[\\/]' },
